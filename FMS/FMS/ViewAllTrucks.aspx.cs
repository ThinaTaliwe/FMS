        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (rows.HasRows)
            {
                ...
                foreach(var id in lstIDs)
                {
                    ...
                    HTMLStr += "<tr>  <td> <a href='TruckInfo?" + truck.getID() + "'>" + truck.getID() + "</a></td> <td> " + truck.getBrand() + "</td> <td> " + truck.getLoad() + "</td><td> " + truck.getSpeed() + "</td><td> " + truck.getClass_code() + "</td></tr>";
                }
