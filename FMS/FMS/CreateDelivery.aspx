<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateDelivery.aspx.cs" Inherits="FMS.CreateDelivery" %>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3 align="center"> Create Delivery </h3>
                                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Order Number</label>
                              <div class="col-sm-10">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                                                      ...
                                                                      <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Load</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                              </div>
                          </div>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                  <button class="btn btn-theme btn-block" href="#" type="submit" > Create Delivery</button>
                              </div>
