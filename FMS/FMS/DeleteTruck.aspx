<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteTruck.aspx.cs" Inherits="FMS.DeleteTruck" %>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3 align="center"> Delete Truck </h3>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                                ...
                                                <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Admin Password</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                  <button class="btn btn-theme btn-block" href="#" type="submit" > Delete Truck</button>
                              </div>
