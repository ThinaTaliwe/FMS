<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteUser.aspx.cs" Inherits="FMS.DeleteUser" %>
          ...
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3 align="center"> Delete User </h3>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                  <button class="btn btn-theme btn-block" href="#" type="submit" > Delete User</button>
                              </div>
