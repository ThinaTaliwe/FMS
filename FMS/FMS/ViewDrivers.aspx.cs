            ...
            if (rows.HasRows)
            {
                while (rows.Read())
                {
                    ...
                    if (rows2.HasRows)
                    {
                        while (rows2.Read())
                        {
                            HTMLStr += "<tr> <td> " + rows.GetString(0) + "</td> <td> " + rows.GetString(1) + "</td> <td> " + rows.GetString(2) + "</td> <td> " + rows2.GetString(0) + "</td> <td> " + rows2.GetDateTime(2) + "</td> <td> " + rows2.GetInt32(1) + "</td> </tr>";
                        }
                    }
                }
