        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (rows.HasRows)
            {
                ...
                foreach (var id in lstIds)
                {
                    ...
                    HTMLStr += "<tr> <td> " + delivery.getClient().getCompany() + "</td> <td> " + delivery.getFromAddress() + "</td> <td> " + delivery.getToAddress() + "</td> <td> " + delivery.getDriver().getName() + " " + delivery.getDriver().getSurname() + "</td> <td> " + delivery.getStarted() + "</td><td>" + delivery.getCompleted() + "</td> <td>  <a href='DeliveryInfo?id=" + delivery.getID() + "'>View     </a> </td> </tr>";
                }
