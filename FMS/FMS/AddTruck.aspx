<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTruck.aspx.cs" Inherits="FMS.AddTruck" %>
                  ...
                  <h3 align="center"> Add Truck </h3>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                                ...
                                                <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Maximum Load</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                              </div>
                          </div>
                                                <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Maximum Speed</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form">
                                  <button class="btn btn-theme btn-block" href="#" type="submit" > Add Truck</button>
                              </div>
